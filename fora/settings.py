"""
Django settings for fora project.
...
SECRET_KEY = 'django-insecure-m%(g=6nn8m_exxi#4!ens+=xf7g#%3t=*+o)x58=y2laxo921g'
...
MIDDLEWARE = [
    ...
    'fora.middleware.SharedPasswordMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'interview.context_processors.interview_context',
            ],
        },
    },
]
